...
export default function AvatarsPage() {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Optional: Update local context if needed (already done via setSelectedAvatar)
      console.log("Avatar saved:", activeAvatar.id);

      // Redirect to patient home dashboard
