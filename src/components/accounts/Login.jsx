...
export default function Login() {
  ...
  async function handleFormSubmit(e) {
    ...
    try {
      ...
      // 3. Send token to backend to set HttpOnly cookie
  ...
  return (
    <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-light text-gray-900">Sign In</h2>
          ...
          <div className="mt-6 flex justify-center">
            <div className="bg-gray-200 rounded-lg p-1 flex">
              <button
                ...
                onClick={() => setRoleHint("patient")}
                className={`px-6 py-2 rounded-md text-sm font-medium transition ${
                  roleHint === "patient" ? "bg-white text-sky-800 shadow" : "text-gray-600"
                }`}
              >
                I'm a Patient
              </button>
              <button
                ...
                onClick={() => setRoleHint("physiotherapist")}
                className={`px-6 py-2 rounded-md text-sm font-medium transition ${
                  roleHint === "physiotherapist" ? "bg-white text-sky-800 shadow" : "text-gray-600"
                }`}
              >
                I'm a Physiotherapist
              </button>
